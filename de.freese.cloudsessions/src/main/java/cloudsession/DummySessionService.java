 ...
 */
public class DummySessionService implements ICloudSession
{
	/**
	 * 
	 */
	...
	private Properties getProps()
	{
		...
		try
		{
			...
			try (FileInputStream fis = new FileInputStream(this.propFileName))
			{
				props.load(fis);
			}
	...
	private void storeProps(final Properties props)
	{
		try
		{
			try (FileOutputStream fos = new FileOutputStream(this.propFileName))
			{
