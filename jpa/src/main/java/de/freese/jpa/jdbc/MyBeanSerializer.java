...
public class MyBeanSerializer implements Serializer
{
    ...
    private static final Function<Property, Parameter> propertyToParameter = new Function<Property, Parameter>()
        ...
        public Parameter apply(final Property input)
        {
             ...
             */
            public MyBeanSerializer(final boolean propertyAnnotations)
            {
             ...
             */
            public MyBeanSerializer(final boolean propertyAnnotations, final String javadocSuffix)
            {
                super();
             ...
             * @param javadocSuffix String
             */
            public MyBeanSerializer(final String javadocSuffix)
            {
            ...
            public void serialize(final EntityType model, final SerializerConfig serializerConfig, final CodeWriter writer) throws IOException
            {
                ...
                // fields
                Comparator<Annotation> annotationComparator = new AnnotationComparator();
