 ...
 */
abstract class AbstractJCacheAdapter<K, V> implements Cache<K, V> {
    ...
    protected AbstractJCacheAdapter(final CacheManager cacheManager, final String name) {
        super();
    ...
    protected void requiredNotClosed() {
        if (isClosed()) {
