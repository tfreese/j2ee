...
public class DatabaseProd
{
    ...
    /**
     * Erstellt ein neues {@link DatabaseProd} Object.
     */
    public DatabaseProd()
    {
        super();
    ...
    public DataSource dataSource()
    {
        ...
        // EmbeddedDatabase dataSource = builder.setType(EmbeddedDatabaseType.DERBY).addScript("classpath:database-prod.sql").build();
        ...
        populator.addScript(new ClassPathResource("database-prod.sql"));
    ...
    // bean.setLocation(new ClassPathResource("classpath:database-prod.properties"));
    //
    // return bean;
    // }
}
