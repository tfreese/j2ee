 ...
 * the editor.
 */
package de.freese.ejb.embedded.servlet;
...
import de.freese.ejb.embedded.bean.IHelloWorldLocal;
...
public class HelloWorldServlet extends HttpServlet
{
     ...
     *
     */
    private static final long serialVersionUID = -4843959305515385590L;

    /**
     *
     */
    @EJB
    private IHelloWorldLocal helloWorld;
    ...
    protected void processRequest(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("<h1>EJB Value: " + this.helloWorld.getHelloWorld() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
