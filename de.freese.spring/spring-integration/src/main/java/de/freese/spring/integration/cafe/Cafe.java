...
/**
 * The entry point for Cafe Demo. The demo's main() method invokes the '<code>placeOrder</code>' method on a generated MessagingGateway proxy. The gateway then
 * passes the {@link Order} as the payload of a {@link Message} to the configured <em>requestChannel</em>. The channel ('orders') is defined in the
 * 'cafeDemo.xml' file.
 * 
 * @author Mark Fisher
 */
