/*
 * JBoss, Home of Professional Open Source Copyright 2015, Red Hat, Inc. and/or its affiliates, and individual contributors by the @authors tag. See the
...
/**
 * A sample program which acts a remote client for a EJB deployed on AS7 server. This program shows how to lookup stateful and stateless beans via JNDI and then
 * invoke on them
 *
 * @author Jaikiran Pai
 */
public class RemoteEJBClient
{
    ...
    private static void invokeStatelessBean() throws NamingException
    {
        ...
        {
            throw new RuntimeException("Remote stateless calculator returned an incorrect difference " + difference + " ,expected difference was "
                    + (num1 - num2));
        }
    }
    ...
    private static RemoteCounter lookupRemoteStatefulCounter() throws NamingException
    {
        ...
        // let's do the lookup
        return (RemoteCounter) context.lookup("ejb:/ejb-remote-server/CounterBean!" + RemoteCounter.class.getName() + "?stateful");
    }
