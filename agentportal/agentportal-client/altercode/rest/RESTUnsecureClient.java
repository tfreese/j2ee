...
public class RESTUnsecureClient {
    ...
    public void testMultipleNewsJSON() throws Exception {
        ...
        try {
            ResponseEntity<SecretNewsList> news = RESTUnsecureClient.template.exchange("http://localhost:8080/secretnews/rest/news", HttpMethod.GET, new HttpEntity<String>(headers), SecretNewsList.class);
